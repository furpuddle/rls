...
use config::Config;
use server::{self, Request, Notification, LsService, NoParams, Action};
use vfs::Vfs;
...
fn help() {
    ...
    println!("                {}", requests::Deglob::METHOD);
    println!("                used for 'deglob'");
    println!("");
    println!("    execute     command args...");
    println!("                {}", requests::ExecuteCommand::METHOD);
